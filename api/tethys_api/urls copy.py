...
urlpatterns = [
    ...
    path("silentPhaseStatus/", views.SilentPhaseStatusView.as_view(), name="silentPhaseStatus-view"),
    path("silentPhaseStatus/force/", views.SilentPhaseStatusForceView.as_view(), name="silentPhaseStatus-force-view"),
