...
class Radio:
    ...
    # =============================================================================
    def checkRadioInbox(self, triggeringIrqPin):
    ...
    def handlePayload(self, channelNo, payload):
        ...
        if command == DATATYPE_CMD_GETCONFIG:
            ...
            package = Radio.DataPackageSensorMoisture(payload)
    ...
    def sendConfig(self, channelNo):
        ...
        try:
            ...
            if responseCode == 200:
                ...
                configPackage = Radio.DataPackageConfiguration(
                ...
                print(
                    "Transmission Power:",
                    channel["sensorTransmissionPowerLevel"],
    ...
    # =============================================================================
    # =============================================================================
    class DataPackageConfiguration:
    ...
    # =============================================================================
    # =============================================================================
    class DataPackageSensorMoisture:
        packageType: np.uint8
