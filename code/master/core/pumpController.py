...
class PumpController:
    ...
    def __init__(
        ...
        # Timezone-aware UTC so the logged start/end are absolute instants. A
        # naive local clock used to be stored mislabeled as UTC by the API,
        # which made every action span the local UTC offset (e.g. +2h) instead
        # of the real pump duration.
