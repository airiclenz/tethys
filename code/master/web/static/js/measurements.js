...
(function (tethys) {
    ...
    (function (measurements) {
        let rows = []; // raw SensorData records (sorted in place)
        ...
        measurements.onChannelChange = onChannelChange;
        // ============================================================================
        function load() {
            return __awaiter(this, void 0, void 0, function* () {
                if (channel === null) {
                ...
                try {
                    const response = yield tethys.getCall(tethys.apiUrl + "sensorData/" + channel);
                    if (!response.ok) {
                        rows = [];
                        render();
                        return;
        ...
        function render() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield templatter.getTemplate("measurement_row.html");
                let content = "";
                rows.forEach(row => {
        ...
        measurements.requestRowDelete = requestRowDelete;
        // ============================================================================
        ...
        measurements.requestDeleteAll = requestDeleteAll;
        // ============================================================================
        ...
        function confirmDelete() {
            ...
            let url;
            if (request.kind === "row") {
                url = tethys.apiUrl + "sensorData/entry/" + request.id;
            }
            else {
                url = tethys.apiUrl + "sensorData/" + channel;
            }
        ...
        measurements.confirmDelete = confirmDelete;
    })(measurements = tethys.measurements || (tethys.measurements = {}));
})(tethys || (tethys = {}));
