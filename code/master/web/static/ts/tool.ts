...
namespace tethys {
    export namespace tool {
        ...
        // ============================================================================
        export function limitValue(elementId: string, minimum: number, maximum: number) {
            var element = <HTMLInputElement>(
                (<unknown>document.getElementById(elementId))
            );
        ...
        // ============================================================================
        export function getTimePassedSinceString(timestamp: Date) {
            var resultString = "";
            ...
            var time =
                pad(timestamp.getHours(), 2) + ":" + pad(timestamp.getMinutes(), 2);
        ...
        // ============================================================================
        export function formatDate(dateObject: any) {
        ...
        // ============================================================================
        export function setVisibleState(
            elementName: string,
            state: boolean,
